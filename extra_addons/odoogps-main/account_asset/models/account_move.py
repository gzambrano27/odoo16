...
class AccountMove(models.Model):
    ...
    #asset_ids = fields.One2many('account.asset', string='Assets', compute="_compute_asset_ids") se comenta para que vaya al nuevo modelo
    ...
    def _compute_asset_ids(self):
        for record in self:
            ...
            record.linked_asset_type = record.asset_ids[:1].type
...
class AccountMoveLine(models.Model):
    ...
    asset_ids = fields.Many2many('account.asset.asset', 'asset_move_line_rel', 'line_id', 'asset_id', string='Related Assets', copy=False)
