    ...
    def import_product_variant(self):
            ...
            for i in range(len(file_reader)):
                ...
                if values:
                    if i == 0:
                        ...
                        product_variant = self.env['product.template'].search([
                        ...
                        if self.product_option == 'create':
                            ...
                            if self.product_search == 'by_code':
                                if not values.get('default_code'):
                                    raise ValidationError(
                                        _('Please provide the Internal Reference when updating products.'))
                                ...
                                if not barcode:
                                    raise ValidationError(
                                        _('Please provide the barcode when updating products.'))
                                ...
                                if product_ids:
                                    ...
                                    if values.get('sale_price'):
                                        product_ids.write({
                                            'list_price': float(values.get('sale_price')) or False
                                        })
                                    if values.get('cost_price'):
                                        product_ids.write({
        ...
        if self.file_import_type == 'xls':
            try:
                ...
                raise ValidationError(
                    _("Please provide an Excel file for importing products!"))
                    ...
                    if self.product_option == 'create':
                        ...
                        if self.product_search == 'by_code':
                            ...
                            if product_ids:
                                ...
                                if line[11]:
                                    product_ids.write({
                                        'list_price': line[11] or False
                                    })
                                if line[12]:
                                    product_ids.write({
                                        'standard_price': float(line[12]) or False
                                    })
                                if line[5]:
                                    product_ids.write({
                                        'weight': line[13] or False
                                    })
                                if line[14]:
                                    product_ids.write({
                                        'volume': line[14] or False
                                    })
                                product_ids.write({
                                    'taxes_id': [(6, 0, tax_id_lst)],
                                    'supplier_taxes_id': [(6, 0, supplier_taxes_id)],
