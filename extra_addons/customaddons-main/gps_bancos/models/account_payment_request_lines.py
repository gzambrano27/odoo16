...
class AccountPaymentRequestLines(models.Model):
    _name = "account.payment.request.lines"
    _description = 'account.payment.request.lines'
    ...
    request_id = fields.Many2one('account.payment.request',ondelete="cascade")
