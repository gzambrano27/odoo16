...
from . import hr_contract_deductible_expenses
...
from . import hr_vacation_period_line_detail
...
from . import hr_employee_movement_line_payslip

from . import hr_employee_update_request

from . import hr_payslip_view
from . import hr_employee_view
from . import maintenance_acta_view
