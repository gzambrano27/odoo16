...
from odoo import _, api, models, exceptions, fields
...
class StockMoveLine(models.Model):
    ...
    # Computar el campo employee_id basado en las asignaciones de requisicion de compra


    #al hacer click en employee_id me salga solo los empleados que tienen asignaciones de requisicion de compra relacionado al campo purchase_request_line_id
    @api.depends('move_id.move_dest_ids.purchase_request_allocation_ids.purchase_request_line_id.request_id.requested_by.employee_id')
    def _compute_employee_id(self):
        for line in self:
            allocations = line.move_id.purchase_request_allocation_ids
            if allocations:
                # Obtener el primer empleado relacionado con las asignaciones de requisicion de compra
                employee = allocations[0].purchase_request_line_id.request_id.requested_by.employee_id
