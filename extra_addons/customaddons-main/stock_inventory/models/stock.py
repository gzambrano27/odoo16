...
class StockInventoryLine(models.Model):
    ...
    categ_id = fields.Many2one(
        "product.category", string="Category", related="product_id.categ_id", store=True
    )
    ...
    def _generate_moves(self):
        ...
        use_inventory_price = config_parameter.get_param(
            key="stock.use_inventory_price", default="True"
        )
